<?php $this->load->view('admin/header',$this->data); ?>
    ...
    <div class="main-content" >
                    ...
                    <div class="col-md-12">
                        ...
                        <form name="search_form" id="search_form" class="form-inline" role="form">
                            <div class="col-md-3 row">
                                <h3 class="pull-left">Dropdowns &nbsp;</h3>
      ...
      <button class="btn btn-default" type="submit"><i class="glyphicon glyphicon-search"></i></button>
                        ...
                        <a href="<?php echo base_url(); ?>admin/dropdown/update" class="btn btn-wide btn-warning pull-right"><i class="glyphicon glyphicon-plus-sign"></i> Add</a>
                            ...
                            <table class="table">
                                ...
                                <?php foreach($rows->result() as $row)
                                {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo base_url(); ?>admin/dropdown/update/?id=<?php echo $row->id; ?>" class="btn btn-transparent btn-xs"><i class="fa fa-pencil"></i> Edit</a>
...
<div class="modal fade" id="DeleteModal">
  <div class="modal-dialog">
    ...
    <form action="<?php echo base_url(); ?>admin/dropdown/delete" method="get" name="delete_model_form" class="form-horizontal" id="delete_model_form" role="form">
