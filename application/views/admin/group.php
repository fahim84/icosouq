...
<?php } ?>
      ...
      <button class="btn btn-default" type="submit"><i class="glyphicon glyphicon-search"></i></button>
        ...
        <a href="<?php echo base_url(); ?>admin/group/update" class="btn btn-wide btn-warning pull-right"><i class="glyphicon glyphicon-plus-sign"></i> Add</a>
            ...
            <table class="table">
                ...
                <?php foreach($rows->result() as $row)
                {
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo base_url(); ?>admin/group/update/?id=<?php echo $row->group_id; ?>" class="btn btn-transparent btn-xs"><i class="fa fa-pencil"></i> Edit</a>
                            <a href="#_" id="<?php echo $row->group_id; ?>" class="btn btn-transparent btn-xs tooltips delete_button" data-toggle="modal" data-target="#DeleteModal" ><i class="fa fa-times fa fa-white"></i> Delete</a>
                        </td>
                    </tr>
                <?php } ?>
                </tbody>
...
<div class="modal fade" id="DeleteModal">
  <div class="modal-dialog">
    ...
    <form action="<?php echo base_url(); ?>admin/group/delete" method="get" name="delete_model_form" class="form-horizontal" id="delete_model_form" role="form">
